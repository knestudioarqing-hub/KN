...
const Stats: React.FC = () => {
  ...
  const stats = [
    { id: 1, value: countProjects, suffix: '+', label: t('stats.projects.label'), icon: Layers, description: t('stats.projects.desc') },
    { id: 2, value: countCountries, suffix: '', label: t('stats.countries.label'), icon: Globe, description: t('stats.countries.desc') },
    { id: 3, value: countRating, suffix: '/5', label: t('stats.rating.label'), icon: Star, description: t('stats.rating.desc') }
  ];
          ...
          {stats.map((stat) => (
            <div key={stat.id} className="flex flex-col items-center text-center px-4 pt-8 md:pt-0">
              ...
              <div className="relative mb-2">
                ...
                <span className="absolute left-0 top-0 text-5xl sm:text-6xl lg:text-7xl font-bold text-brand-orange/10 blur-xl select-none pointer-events-none -z-10">{stat.value}{stat.suffix}</span>
              </div>
