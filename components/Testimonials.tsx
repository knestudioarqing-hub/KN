...
const Testimonials: React.FC = () => {
  ...
  return (
    <section id="depoimentos" className="relative py-24 sm:py-32 bg-brand-secondary dark:bg-black overflow-hidden border-t border-gray-200 dark:border-white/5 transition-colors duration-500">
