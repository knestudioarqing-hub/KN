    ...
    <div className="relative rounded-t-xl sm:rounded-t-3xl border border-gray-200 dark:border-white/10 bg-[#0A0A0A] dark:bg-[#0A0A0A]/80 backdrop-blur-xl shadow-2xl overflow-hidden animate-float" style={{ animationDuration: '8s' }}>
      ...
      <div className="p-4 sm:p-6 md:p-8 grid grid-cols-1 lg:grid-cols-3 gap-6 h-auto min-h-[300px]">
        ...
        <div className="lg:col-span-2 space-y-4 sm:space-y-6">
            ...
            <div className="bg-white/5 rounded-xl border border-white/5 overflow-hidden">
                <div className="overflow-x-auto">
                    <div className="min-w-[400px] grid grid-cols-12 gap-4 p-4 text-xs font-medium text-gray-500 border-b border-white/5 uppercase tracking-wider">
                    ...
                    {products.map((name: string, index: number) => (
                        <div key={index} className="min-w-[400px] grid grid-cols-12 gap-4 p-4 items-center hover:bg-white/5 transition-colors border-b border-white/5 last:border-0 group">
        ...
        <div className="space-y-4 sm:space-y-6">
            ...
            <div className="bg-white/5 rounded-xl border border-white/5 p-0 h-full min-h-[250px] relative overflow-hidden group flex flex-col justify-end">
                ...
                <div className="relative w-full h-[180px] z-10">
                 ...
                 {/* X Axis Labels */}
                 <div className="flex justify-between px-4 pb-4 pt-2 text-[10px] sm:text-xs text-gray-500 z-20 bg-gradient-to-t from-[#0A0A0A] to-transparent">
                    <span>Mon</span>
                    <span>Tue</span>
                    <span>Wed</span>
                    <span>Thu</span>
